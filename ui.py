...
from book_processing import (extract_book_details, fetch_google_books,
                             preprocess_descriptions, recommend_books)
...
def setup_ui(root):
    ...
    label_query = tk.Label(frame_query, text="Enter your query :")
    ...
    # Bouton de recherche
    button_search = tk.Button(root, text="To research", command=lambda: search_books(entry_query, listbox_books, button_recommend))
    button_search.pack()
